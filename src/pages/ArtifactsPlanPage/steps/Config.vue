<template>
    <div>
        ...
        <div class="config-item">
            <h3 class="config-title" style="margin-bottom: 20px">Limit Main Stat</h3>
            <div class="flex-row row">
                <span class="cmt-label fs-14 color-normal">Sands of Eon</span>
        ...
        <div class="config-item">
            <h3 class="config-title" style="margin-bottom: 20px">Minimum Stat Limi</h3>
            <div class="flex-row row">
