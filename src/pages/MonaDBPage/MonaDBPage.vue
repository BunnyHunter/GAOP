<template>
    <div v-loading="loading">
        <el-breadcrumb style="margin-bottom: 12px; height: 24px">
            <el-breadcrumb-item>Database</el-breadcrumb-item>
        </el-breadcrumb>

<!--        <el-divider></el-divider>-->

        <div v-if="error" @click="handleClickReload">Error loading data, click retry</div>
        <div v-else>
            <el-tabs>
                <el-tab-pane label="Character" name="character">
                    <el-row :gutter="12">
                        ...
                        <el-col :span="20" v-if="analysisResult">
                            <div class="tab-full-height mona-scroll-hidden">
                                <p class="analysis-item-title">Weapon Usage</p>
                                <div
                ...
                <el-tab-pane label="Weapons" name="weapon"></el-tab-pane>
            </el-tabs>
        </div>
    </div>
</template>
