        ...
        >
            <p class="common-title2">
                ...
                <el-tooltip>
                    ...
                    <template #content>
                        A*: Recommended<br>
                        Heuristic Pruning: not guaranteed to get the optimal solution, but fast<br>
                        Pure Enumeration: not recommended
                    </template>
                </el-tooltip>
            </p>
            <el-alert
                v-if="algorithm === 'Naive'"
                title="Please limit the set or main stat, otherwise the calculation will be very time-consuming and may cause the calculation to time out"
                type="warning"
                style="margin-bottom: 12px"
            ></el-alert>
            <el-radio-group v-model="algorithm">
                <el-radio label="AStar">A*</el-radio>
                <el-radio label="Heuristic">Heuristic Pruning</el-radio>
                <el-radio label="Naive">Pure Enumeration</el-radio>
            </el-radio-group>

            <p class="common-title2">Limit Set</p>
            ...
            <p class="common-title2">Limit Main Stat</p>
            <div style="margin-top: 12px; margin-bottom: 12px">
                <div class="constraint-main-stat-item">
                    <span>Sands of Eon</span>
            ...
            <p class="constraint-title">Minimum Limit</p>
            <div>
                <div class="constraint-min-item">
                    <span class="constraint-min-title">Energy Recharge</span>
                    <div style="width: 40%">
                        <el-slider
                            :min="1"
                            :max="4"
                ...
                <div class="constraint-min-item">
                    <span class="constraint-min-title">Elemental Mastery</span>
                    <div style="width: 40%">
                        <el-slider
                            :min="0"
                            :max="2000"
                ...
                <div class="constraint-min-item">
                    <span class="constraint-min-title">Crit Chance</span>
                    <div style="width: 40%">
                        <el-slider
                            :min="0"
                            :max="1"
                ...
                <div class="constraint-min-item">
                    <span class="constraint-min-title">Crit Damage</span>
                    <div style="width: 40%">
                        <el-slider
                            :min="0"
                            :max="4"
            ...
            <p class="common-title2">Filter Artifact Sets</p>
...
<!--    stats marginal bonus    -->
        ...
        <el-dialog
            ...
            width="60%"
        >
            <h3 class="common-title2">Artifact Effect Mode</h3>
            <el-radio-group
                v-model="artifactEffectMode"
            >
                <el-radio label="auto">Automatic</el-radio>
                <el-radio label="custom">Manual</el-radio>
            </el-radio-group>

            <h3 class="common-title2">Artifact Effect (only available in manual mode)</h3>
            <artifact-config
        ...
        <div class="top-things" ref="topThings">
            <el-breadcrumb>
                <el-breadcrumb-item>Character Optimizations</el-breadcrumb-item>
            </el-breadcrumb>
            ...
            <el-col class="left-container" :span="6">
                <div class="config-character">
                    ...
                    <div class="select-character">
                        <p class="common-title">Character</p>
                        ...
                        <div class="config-character-skill">
                            <h3 class="common-title2">Skills</h3>
                            <div class="skill-div">
                                <el-input-number
                                    size="mini"
                        ...
                        <div class="config-character-constellation">
                            <h3 class="common-title2">Constellations</h3>
                            <el-input-number
                                size="mini"
                                controls-position="right"
                ...
                <div class="config-weapon">
                    ...
                    <div class="select-weapon">
                        ...
                        <div class="config-weapon-refine">
                            <h3 class="common-title2">Refinement</h3>
                            <el-input-number
                                size="mini"
                                controls-position="right"
                ...
                <div class="config-target-function">
                    <p class="common-title">Target Function</p>
                    <div class="my-button-list" style="margin-bottom: 12px">
                       ...
                       >Calculation Settings</el-button>
                    ...
                    <div class="my-button-list" style="margin-bottom: 12px">
                        <el-dropdown
                            ...
                            split-button
                        >
                            <template v-if="!miscCurrentPresetName">New Preset</template>
                            <template v-else>Save as Default {{ miscCurrentPresetName }} </template>
                            ...
                            <template #dropdown>
                                <el-dropdown-menu>
                                    <el-dropdown-item
                                        ...
                                        icon="el-icon-s-tools"
                                        command="save-preset"
                                    >Save as Preset</el-dropdown-item>
    <!--                                    <el-dropdown-item icon="el-icon-s-help" command="setup-artifact">圣遗物设置</el-dropdown-item>-->
...
<!--                    </div>-->
                    ...
                    >
                        <el-alert
                            :title="`Optimization Results ${optimizationResults.length} `"
                            type="success"
                            style="margin-bottom: 12px"
                        ></el-alert>
                        <el-input-number
                ...
                <div class="config-buff">
                    <p class="common-title">Buffs</p>
                    <div class="buff-tool" style="margin-bottom: 12px">
                        <my-button-1 icon="el-icon-plus" title="Add Buff"
                    ...
                    <div v-else>
                        <el-empty description="No Buffs"></el-empty>
                    </div>
                </div>
            </el-col>

            <el-col :span="12" class="middle-container">
                <p class="common-title">Artifacts</p>
...
<!--                    ></my-button-1>-->
                    ...
                    >Save as Artifact Set</el-button>
...
<!--                    ></my-button-1>-->
                ...
                <div v-if="artifactNeedConfig4" style="margin-top: 16px">
                    <p class="common-description">
                        <span class="effect4">4 Piece Effect：</span>
                ...
                <p class="common-title">Damage Calculation</p>
                <div class="my-button-list" style="margin-bottom: 12px">
                    <el-button
                        size="mini"
                        icon="el-icon-s-data"
...
<!--                    ></my-button-1>-->
                ...
                <h3 class="common-title2" style="margin-top: 24px">Transformative Reactions</h3>
            ...
            <el-col :span="6" class="right-container">
                <div class="common-title">Panel</div>
...
export default {
    ...
    methods: {
        ...
        handleClickSaveOptimizeConfig() {
            ...
            this.$prompt("Enter a name (duplicate names will overwrite)", "Save as default", {
        ...
        handleOptimizeArtifact() {
            ...
            wasmSingleOptimize(this.getOptimizeArtifactWasmInterface(), this.getArtifactsToBeCalculated()).then(results => {
                ...
                if (results.length === 0) {
                    this.$message.error("No Eligible Artifacts")
                    return
                }
