...
impl ItemConfig {
    pub const DEFAULT_RATE_TITLE: &'static str = "Passive Application Ratio";
    pub const DEFAULT_STACK_TITLE: &'static str = "Passive Equivalent Stacks";
    pub const DEFAULT_RECHARGE_TITLE: &'static str = "Energy Recharge Needed";
    pub const DEFAULT_BUFF_TITLE: &'static str = "Value";
    ...
    pub const REFINE: ItemConfig = ItemConfig { name: "refine", title: "Refinement Level", config: ItemConfigType::IntInput { min: 1, max: 5, default: 1 } };
