...
impl Default for ComplicatedAttributeGraph {
    fn default() -> Self {
        ...
        unsafe {
            (*data)[AttributeName::CriticalBase as usize].set_self_value_by("Value", 0.05);
            (*data)[AttributeName::CriticalDamageBase as usize].set_self_value_by("Value", 0.5);
            (*data)[AttributeName::Recharge as usize].set_self_value_by("Value", 1.0);
        }
