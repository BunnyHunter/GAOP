...
impl TargetFunctionMetaTrait for YaeMikoDefaultTargetFunction {
    ...
    const META_DATA: TargetFunctionMeta = TargetFunctionMeta {
        ...
        chs: "Yae Miko - Default",
        description: "Average Damage/DPS ",
        tags: "Damage",
    ...
    const CONFIG: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            ...
            title: "Electro Charge Relative Frequency",
            config: ItemConfigType::Float { min: 0.0, max: 3.0, default: 0.0 }
        },
        ItemConfig {
            name: "overload_times",
            title: "Overload Relative Frequency",
            config: ItemConfigType::Float { min: 0.0, max: 1.0, default: 0.0 }
        },
        ItemConfig {
            name: "recharge_demand",
            title: "Energy Recharge Requirements",
