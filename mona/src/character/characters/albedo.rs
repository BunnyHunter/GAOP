...
const ALBEDO_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Favonius Bladework - Weiss",
    skill_name2: "Elemental Skill: Abiogenesis: Solar Isotoma",
    skill_name3: "Elemental Burst: Rite of Progeniture: Tectonic Tide"
};
...
impl CharacterTrait for Albedo {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: AlbedoDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::Charged11 as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::Charged12 as usize, chs: "2- Charge Attack Damagee" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::Plunging1 as usize, chs: "Plunge Attack" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::Plunging3 as usize, chs: "High Plunge Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: AlbedoDamageEnum::E1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::ETransientBlossom as usize, chs: "Tansient Blossom Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: AlbedoDamageEnum::Q1 as usize, chs: "Elemental Burst Damage" },
            CharacterSkillMapItem { index: AlbedoDamageEnum::QFatalBlossom as usize, chs: "Fatal Blossom Damage" },
        ])
    };
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if s.is_def_ratio() {
            builder.add_def_ratio("Skill Multiplier", ratio)
        } else {
            builder.add_atk_ratio("Skill Multiplier", ratio)
        }
        if context.character_common_data.constellation >= 2 {
            builder.add_def_ratio("Abedo's 2nd Constellation: Opening of Phanerozoic", fatal_count as f64 * 0.3);
        }
