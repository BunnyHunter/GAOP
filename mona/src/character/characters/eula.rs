...
pub const EULA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Favonius Bladework - Edel",
    skill_name2: "Elemental Skill: Icetide Vortex",
    skill_name3: "Elemental Burst: Glacial Illumination"
};
...
impl CharacterTrait for Eula {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: EulaDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: EulaDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: EulaDamageEnum::Normal31 as usize, chs: "3- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: EulaDamageEnum::Normal32 as usize, chs: "3- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: EulaDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: EulaDamageEnum::Normal51 as usize, chs: "5- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: EulaDamageEnum::Normal52 as usize, chs: "5- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: EulaDamageEnum::Charged1 as usize, chs: "Charge Attack Spinning DMG" },
            CharacterSkillMapItem { index: EulaDamageEnum::Charged2 as usize, chs: "Charge Attack Final DMG" },
            CharacterSkillMapItem { index: EulaDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: EulaDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: EulaDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: EulaDamageEnum::E1 as usize, chs: "Tap Damage" },
            CharacterSkillMapItem { index: EulaDamageEnum::E2 as usize, chs: "Hold Damage" },
            CharacterSkillMapItem { index: EulaDamageEnum::E3 as usize, chs: "Icewhirl Brand Damage" },
            CharacterSkillMapItem { index: EulaDamageEnum::EShatteredLightfall as usize, chs: "Shattered Lightfall Sword Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: EulaDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: EulaDamageEnum::QLightfall as usize, chs: "Lightfall Sword Damage" },
        ])
    };
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if s == QLightfall {
            ...
            builder.add_atk_ratio("Lightfall Sword Energy", (stack as f64) * EULA_SKILL.elemental_burst_dmg3[s3]);
        }
