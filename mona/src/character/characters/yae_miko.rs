...
impl CharacterTrait for YaeMiko {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        star: 5,
        skill_name1: "Normal Attack: Spiritfox Sin-Eater",
        skill_name2: "Elemental Skill: Yakan Evocation: Sesshou Sakura",
        skill_name3: "Elemental Burst: Great Secret Art: Tenko Kenshin"
    };
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: YaeMikoDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: YaeMikoDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: YaeMikoDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: YaeMikoDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: YaeMikoDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: YaeMikoDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: YaeMikoDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: YaeMikoDamageEnum::E1 as usize, chs: "Sesshou Sakura Damage: Level 1" },
            CharacterSkillMapItem { index: YaeMikoDamageEnum::E2 as usize, chs: "Sesshou Sakura Damage: Level 2" },
            CharacterSkillMapItem { index: YaeMikoDamageEnum::E3 as usize, chs: "Sesshou Sakura Damage: Level 3" },
            CharacterSkillMapItem { index: YaeMikoDamageEnum::E4 as usize, chs: "Sesshou Sakura Damage: Level 4" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: YaeMikoDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: YaeMikoDamageEnum::Q2 as usize, chs: "Tenko Thunderbolt Damage" },
        ])
    };
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if context.character_common_data.has_talent2 {
            ...
            builder.add_extra_bonus("Yae Miko's 2nd Ascension Talent: Enlightened Blessing", em * 0.0015);
        }

        let skill_type = s.get_skill_type();
        if context.character_common_data.constellation >= 6 && skill_type == SkillType::ElementalSkill {
            builder.add_extra_def_penetration("Yae Miko's 6th Constellation: Forbidden Art: Daisesshou", 0.6);
        }
