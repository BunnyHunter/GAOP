...
pub const ZHONGLI_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Rain of Stone",
    skill_name2: "Elemental Skill: Dominus Lapidis",
    skill_name3: "Elemental Burst: Planet Befall"
};
...
impl<T: Attribute> ChangeAttribute<T> for ZhongliEffect {
    fn change_attribute(&self, attribute: &mut T) {
        if self.has_talent2 {
            attribute.set_value_by(AttributeName::HPRatioNormalAttack, "Zhongli's 2nd Ascension Talent: Dominance of Earth", 0.0139);
            attribute.set_value_by(AttributeName::HPRatioChargedAttack, "Zhongli's 2nd Ascension Talent: Dominance of Earth", 0.0139);
            attribute.set_value_by(AttributeName::HPRatioPlungingAttack, "Zhongli's 2nd Ascension Talent: Dominance of Earth", 0.0139);
            attribute.set_value_by(AttributeName::HPRatioElementalSkill, "Zhongli's 2nd Ascension Talent: Dominance of Earth", 0.019);
            attribute.set_value_by(AttributeName::HPRatioElementalBurst, "Zhongli's 2nd Ascension Talent: Dominance of Earth", 0.33);
        }
    }
}
...
impl CharacterTrait for Zhongli {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: ZhongliDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage/4" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::Normal6 as usize, chs: "6- Normal Attack Damage" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: ZhongliDamageEnum::E1 as usize, chs: "Stone Stele Damage" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::E2 as usize, chs: "Resonance Damage" },
            CharacterSkillMapItem { index: ZhongliDamageEnum::E3 as usize, chs: "Hold Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: ZhongliDamageEnum::Q1 as usize, chs: "Skill Damage" },
        ])
    };
