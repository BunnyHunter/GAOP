...
pub const QIQI_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Ancient Sword Art",
    skill_name2: "Elemental Skill: Adeptus Art: Herald of Frost",
    skill_name3: "Elemental Burst: Adeptus Art: Preserver of Fortune"
};
...
impl CharacterTrait for Qiqi {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: QiqiDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Normal31 as usize, chs: "3- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Normal32 as usize, chs: "3- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Normal41 as usize, chs: "4- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Normal42 as usize, chs: "4- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Charged11 as usize, chs: "1- Charged Attack Damage-1" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Charged12 as usize, chs: "1- Charged Attack Damage-2" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: QiqiDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: QiqiDamageEnum::E1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: QiqiDamageEnum::E2 as usize, chs: "Herald of Frost Damage" },
            CharacterSkillMapItem { index: QiqiDamageEnum::EHeal1 as usize, chs: "Regeneration on Hit" },
            CharacterSkillMapItem { index: QiqiDamageEnum::EHeal2 as usize, chs: "Continuous Regeneration" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: QiqiDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: QiqiDamageEnum::QHeal1 as usize, chs: "Healing" },
        ])
    };
