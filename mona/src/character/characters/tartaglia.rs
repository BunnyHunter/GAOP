...
pub const TARTAGLIA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Cutting Torrent",
    skill_name2: "Elemental Skill: Foul Legacy: Raging Tide",
    skill_name3: "Elemental Burst: Havoc: Obliteration"
};
...
impl CharacterTrait for Tartaglia {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: TartagliaDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Normal6 as usize, chs: "6- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Charged1 as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Charged2 as usize, chs: "2- Charged Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::NormalRiptideFlash as usize, chs: "Riptide Slash Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::NormalRiptideBurst as usize, chs: "Riptide Burst Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: TartagliaDamageEnum::E1 as usize, chs: "Stance Change Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::ENormal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::ENormal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::ENormal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::ENormal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::ENormal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::ENormal61 as usize, chs: "6- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::ENormal62 as usize, chs: "6- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::ECharged11 as usize, chs: "1- Charged Attack Damage-1" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::ECharged12 as usize, chs: "Charged Attack Damage-2" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::ERiptideSlash as usize, chs: "Riptide Slash" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: TartagliaDamageEnum::Q1 as usize, chs: "Skill Damage (Melee)" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::Q2 as usize, chs: "Skill Damage (Ranged)" },
            CharacterSkillMapItem { index: TartagliaDamageEnum::QRiptideBlast as usize, chs: "Riptide Blast Damage" },
        ])
    };
