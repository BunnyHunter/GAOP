...
pub const SANGONOMIYA_KOKOMI_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: The Shape of Water",
    skill_name2: "Elemental Skill: Kurage's Oath",
    skill_name3: "Elemental Burst: Nereid's Ascension"
};
...
impl<T: Attribute> ChangeAttribute<T> for SangonomiyaKokomiEffect {
    fn change_attribute(&self, attribute: &mut T) {
        attribute.set_value_by(AttributeName::CriticalBase, "Sangonomiya Kokomi's Passive: Flawless Strategy", -1.0);
        attribute.set_value_by(AttributeName::HealingBonus, "Sangonomiya Kokomi's Passive: Flawless Strategy", 0.25);
    }
}
...
impl CharacterTrait for SangonomiyaKokomi {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::E1 as usize, chs: "Ripple Damage" },
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::EHeal1 as usize, chs: "Regeneration	" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: SangonomiyaKokomiDamageEnum::QHeal1 as usize, chs: "HP Regeneration Per Hit" },
        ])
    };
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "after_q",
            title: "Elemental Burst: Nereid's Ascension",
        ...
        if s.is_heal() {
            ...
            if after_q {
                if skill_type == SkillType::NormalAttack {
                    ...
                    builder.add_hp_ratio("Sangonomiya Kokomi's 2nd Ascension Talent Damage Bonus", bonus);
                    if context.character_common_data.has_talent2 {
                        let healing_bonus = context.attribute.get_value(AttributeName::HealingBonus);
                        builder.add_hp_ratio("Sangonomiya Kokomi's 2nd Ascension Talent: Song of Pearls	", healing_bonus * 0.15);
                    }
