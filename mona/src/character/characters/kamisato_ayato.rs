...
impl CharacterTrait for KamisatoAyato {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        star: 5,
        skill_name1: "Normal Attack: Kamisato Art: Korobi",
        skill_name2: "Elemental Skill: Kamisato Art: Kyoka",
        skill_name3: "Elemental Burst: Kamisato Art: Suiyuu"
    };
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::Normal4Div2 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::Charged1 as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::ENormal1 as usize, chs: "Shunsuiken 1-Hit Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::ENormal2 as usize, chs: "Shunsuiken 2-Hit Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::ENormal3 as usize, chs: "Shunsuiken 3-Hit Damage" },
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::E4 as usize, chs: "Water Illusion Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: KamisatoAyatoDamageEnum::Q1 as usize, chs: "Bloomwater Blade Damage" },
        ])
    };
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "e_stack",
            title: "Elemental Skill: Kamisato Art: Kyoka Stacks",
            config: ItemConfigType::Int { min: 0, max: 5, default: 4 }
        },
        ItemConfig {
            name: "in_q",
            title: "Elemental Burst: Kamisato Art: Suiyuu",
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if s.is_e_normal() {
            ...
            builder.add_extra_damage("Elemental Skill: Kamisato Art: Kyoka Stacks ATK Bonus", extra);
        }

        let skill_type = s.get_skill_type();
        if skill_type == SkillType::NormalAttack && in_q {
            builder.add_extra_bonus("Elemental Burst: Kamisato Art: Suiyuu Damage Increase", KAMISATO_AYATO_SKILL.elemental_burst_bonus[s3]);
        }
