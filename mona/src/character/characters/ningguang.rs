...
pub const NINGGUANG_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Sparkling Scatter",
    skill_name2: "Elemental Skill: Jade Screen",
    skill_name3: "Elemental Burst: Starshatter"
};
...
impl<A: Attribute> ChangeAttribute<A> for NingguangEffect {
    fn change_attribute(&self, attribute: &mut A) {
        if self.has_talent2 {
            attribute.set_value_by(AttributeName::BonusGeo, "Ningguang's 2nd Ascesion Talent: Strategic Reserve", self.rate * 0.12);
        }
    }
}
...
impl CharacterTrait for Ningguang {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: NingguangDamageEnum::Normal as usize, chs: "Normal Attack Damage" },
            CharacterSkillMapItem { index: NingguangDamageEnum::Charged1 as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: NingguangDamageEnum::Charged2 as usize, chs: "2- Charged Attack Damage" },
            CharacterSkillMapItem { index: NingguangDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: NingguangDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: NingguangDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: NingguangDamageEnum::E1 as usize, chs: "Skill Damage" }
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: NingguangDamageEnum::Q1 as usize, chs: "Damage Per Gem" }
        ])
    };
    ...
    const CONFIG_DATA: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "talent2_rate",
            title: "Ningguang's 2nd Ascesion Talent Uptime",
