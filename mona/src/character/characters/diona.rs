...
pub const DIONA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Kätzlein Style",
    skill_name2: "Elemental Skill: Icy Paws",
    skill_name3: "Elemental Burst: Signature Mix"
};
...
impl CharacterTrait for Diona {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: DionaDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::Charged1 as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::Charged2 as usize, chs: "2- Charged Attack Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: DionaDamageEnum::E1 as usize, chs: "Icy Paw Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: DionaDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::Q2 as usize, chs: "Continuous Field Damage" },
            CharacterSkillMapItem { index: DionaDamageEnum::QHeal as usize, chs: "HP Regeneration Over Time" },
        ])
    };
