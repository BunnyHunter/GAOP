...
const SHENHE_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Dawnstar Piercer",
    skill_name2: "Elemental Skill: Spring Spirit Summoning",
    skill_name3: "Elemental Burst: Divine Maiden's Deliverance"
};
...
impl CharacterTrait for Shenhe {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: ShenheDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: ShenheDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: ShenheDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: ShenheDamageEnum::Normal41 as usize, chs: "4- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: ShenheDamageEnum::Normal42 as usize, chs: "4- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: ShenheDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: ShenheDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: ShenheDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: ShenheDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: ShenheDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: ShenheDamageEnum::E1 as usize, chs: "Tap Skill Damage" },
            CharacterSkillMapItem { index: ShenheDamageEnum::E2 as usize, chs: "Hold Skill Damage " },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: ShenheDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: ShenheDamageEnum::Q2 as usize, chs: "Damage Over Time" },
        ])
    };
