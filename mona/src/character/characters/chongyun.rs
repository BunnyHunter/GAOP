...
pub const CHONGYUN_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Demonbane",
    skill_name2: "Elemental Skill: Spirit Blade: Chonghua's Layered Frost",
    skill_name3: "Elemental Burst: Spirit Blade: Cloud-Parting Star"
};
...
impl CharacterTrait for Chongyun {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: ChongyunDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: ChongyunDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: ChongyunDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: ChongyunDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: ChongyunDamageEnum::Charged1 as usize, chs: "Charge Attack Spinning Damage" },
            CharacterSkillMapItem { index: ChongyunDamageEnum::Charged2 as usize, chs: "Charge Attack Final Damage" },
            CharacterSkillMapItem { index: ChongyunDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: ChongyunDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: ChongyunDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: ChongyunDamageEnum::E1 as usize, chs: "Skill Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: ChongyunDamageEnum::Q1 as usize, chs: "Skill Damage" },
        ])
    };
