...
pub const YANFEI_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Seal of Approval",
    skill_name2: "Elemental Skill: Signed Edict",
    skill_name3: "Elemental Burst: Done Deal"
};
...
impl CharacterTrait for Yanfei {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: YanfeiDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::Charged1 as usize, chs: "Charge Attack Damage 0 Seals" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::Charged2 as usize, chs: "Charge Attack Damage 1 Seals" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::Charged3 as usize, chs: "Charge Attack Damage 2 Seals" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::Charged4 as usize, chs: "Charge Attack Damage 3 Seals" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::Charged5 as usize, chs: "Charge Attack Damage 4 Seals" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::DmgTalent2 as usize, chs: "Yanfei's 2nd Ascension Talent: Blazing Eye Damage" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: YanfeiDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: YanfeiDamageEnum::E1 as usize, chs: "Skill Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: YanfeiDamageEnum::Q1 as usize, chs: "Skill Damage" }
        ])
    };
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "after_q",
            title: "Elemental Burst Effect: Brilliance",
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if skill_type == SkillType::ChargedAttack && after_q {
            ...
            builder.add_extra_bonus("Elemental Burst Effect: Brilliance", bonus);
        }
