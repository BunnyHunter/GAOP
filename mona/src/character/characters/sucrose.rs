...
pub const SUCROSE_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Wind Spirit Creation",
    skill_name2: "Elemental Skill: Astable Anemohypostasis Creation - 6308",
    skill_name3: "Elemental Burst: Forbidden Creation - Isomer 75 / Type II"
};
...
impl CharacterTrait for Sucrose {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: SucroseDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: SucroseDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: SucroseDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: SucroseDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: SucroseDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: SucroseDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: SucroseDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: SucroseDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: SucroseDamageEnum::E1 as usize, chs: "Skill DMG" }
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: SucroseDamageEnum::Q1 as usize, chs: "Damage Over Time " },
            CharacterSkillMapItem { index: SucroseDamageEnum::Q2Pyro as usize, chs: "Additional Pyro Element Damage" },
            CharacterSkillMapItem { index: SucroseDamageEnum::Q2Hydro as usize, chs: "Additional Hydro Element Damage" },
            CharacterSkillMapItem { index: SucroseDamageEnum::Q2Cryo as usize, chs: "Additional Cryo Element Damage" },
            CharacterSkillMapItem { index: SucroseDamageEnum::Q2Electro as usize, chs: "Additional Electro Element Damage" },
        ])
    };
