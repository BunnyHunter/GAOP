...
pub const KLEE_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Kaboom!",
    skill_name2: "Elemental Skill: Jumpy Dumpty",
    skill_name3: "Elemental Burst: Sparks 'n' Splash"
};
...
impl CharacterTrait for Klee {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: KleeDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: KleeDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: KleeDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: KleeDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: KleeDamageEnum::ChargedWithTalent as usize, chs: "Charged Attack Damage (Pounding Surprise)" },
            CharacterSkillMapItem { index: KleeDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: KleeDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: KleeDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: KleeDamageEnum::E1 as usize, chs: "Jumpy Dumpty Damage " },
            CharacterSkillMapItem { index: KleeDamageEnum::E2 as usize, chs: "Mine Damage " },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: KleeDamageEnum::Q1 as usize, chs: "Sparks 'n' Splash Damage " }
        ])
    };
