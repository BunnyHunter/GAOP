...
const ARATAKI_ITTO_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Fight Club Legend",
    skill_name2: "Elemental Skill: Masatsu Zetsugi: Akaushi Burst!",
    skill_name3: "Elemental Burst: Royal Descent: Behold, Itto the Evil!"
};
...
impl<A: Attribute> ChangeAttribute<A> for AratakiIttoEffect {
    fn change_attribute(&self, attribute: &mut A) {
        if self.c6 {
            attribute.set_value_by(AttributeName::CriticalDamageChargedAttack, "Arataki Itto's 6th Constellation: Arataki Itto, Present!", 0.7);
        }
    }
}
...
impl CharacterTrait for AratakiItto {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::KesagiriCombo as usize, chs: "Arataki Kesagiri Combo Slash Damage" },
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::KesagiriFinal as usize, chs: "Arataki Kesagiri Final Slash Damage" },
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::Saichimonji as usize, chs: "Saichimonji Slash Damage " },
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: AratakiIttoDamageEnum::E1 as usize, chs: "Skill Damage" }
        ]),
        skill3: None
    };
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if after_q {
            ...
            builder.add_extra_atk("Elemental Burst ATK Bonus", atk_bonus);
        }

        if s.is_kesagiri() && context.character_common_data.has_talent2 {
            builder.add_def_ratio("Arataki Itto's 2nd Ascension Talent: Bloodline of the Crimson Oni", 0.35);
        }
