...
const YUNJIN_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Cloud-Grazing Strike",
    skill_name2: "Elemental Skill: Opening Flourish",
    skill_name3: "Elemental Burst: Cliffbreaker's Banner"
};
...
impl CharacterTrait for Yunjin {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: YunjinDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: YunjinDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: YunjinDamageEnum::Normal31 as usize, chs: "3- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: YunjinDamageEnum::Normal32 as usize, chs: "3- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: YunjinDamageEnum::Normal41 as usize, chs: "4- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: YunjinDamageEnum::Normal42 as usize, chs: "4- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: YunjinDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: YunjinDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: YunjinDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: YunjinDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: YunjinDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: YunjinDamageEnum::E1 as usize, chs: "Tap Damage" },
            CharacterSkillMapItem { index: YunjinDamageEnum::E2 as usize, chs: "Charge Level 1 Damage" },
            CharacterSkillMapItem { index: YunjinDamageEnum::E3 as usize, chs: "Charge Level 2 Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: YunjinDamageEnum::Q1 as usize, chs: "Skill Damage" }
        ])
    };
