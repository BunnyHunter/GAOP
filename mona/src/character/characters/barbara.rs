...
pub const BARBARA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Whisper of Water",
    skill_name2: "Elemental Skill: Let the Show Begin♪",
    skill_name3: "Elemental Burst: Shining Miracle♪"
};
...
impl CharacterTrait for Barbara {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: BarbaraDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: BarbaraDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: BarbaraDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: BarbaraDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: BarbaraDamageEnum::Charged as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: BarbaraDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: BarbaraDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: BarbaraDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: BarbaraDamageEnum::EHeal1 as usize, chs: "HP Regeneration Per Hit" },
            CharacterSkillMapItem { index: BarbaraDamageEnum::EHeal2 as usize, chs: "Continuous Regeneration" },
            CharacterSkillMapItem { index: BarbaraDamageEnum::EDmg as usize, chs: "Droplet Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: BarbaraDamageEnum::QHeal as usize, chs: "Regeneration" },
        ])
    };
