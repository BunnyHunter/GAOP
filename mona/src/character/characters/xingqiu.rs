...
pub const XINGQIU_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Guhua Style",
    skill_name2: "Elemental Skill: Guhua Sword: Fatal Rainscreen",
    skill_name3: "Elemental Burst: Guhua Sword: Raincutter"
};
...
impl<A: Attribute> ChangeAttribute<A> for XingqiuEffect {
    fn change_attribute(&self, attribute: &mut A) {
        if self.has_talent2 {
            attribute.set_value_by(AttributeName::BonusHydro, "Elemental Burst Effect: Rainbow Bladework", 0.2);
        }
    }
}
...
impl CharacterTrait for Xingqiu {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: XingqiuDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Normal31 as usize, chs: "3- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Normal32 as usize, chs: "3- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Normal51 as usize, chs: "5- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Normal52 as usize, chs: "5- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Charged11 as usize, chs: "1- Charged Attack Damage-1" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Charged12 as usize, chs: "Charged Attack Damage-2" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: XingqiuDamageEnum::E11 as usize, chs: "Skill Damage-1" },
            CharacterSkillMapItem { index: XingqiuDamageEnum::E12 as usize, chs: "Skill Damage-2" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: XingqiuDamageEnum::Q1 as usize, chs: "Sword Rain Damage" }
        ])
    };
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "c4",
            title: "Xingqiu's 4th Constellation: Evilsoother",
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if c4 && (s == E11 || s == E12) {
            builder.add_atk_ratio("Xingqiu's 4th Constellation: Evilsoother", ratio * 0.5);
        }
