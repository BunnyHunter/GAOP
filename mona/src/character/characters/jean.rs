...
pub const JEAN_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Favonius Bladework",
    skill_name2: "Elemental Skill: Gale Blade",
    skill_name3: "Elemental Burst: Dandelion Breeze"
};
...
impl CharacterTrait for Jean {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: JeanDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: JeanDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: JeanDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: JeanDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: JeanDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: JeanDamageEnum::Charged as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: JeanDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: JeanDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: JeanDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: JeanDamageEnum::E1 as usize, chs: "Skill Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: JeanDamageEnum::Q1 as usize, chs: "Elemental Burst Damage " },
            CharacterSkillMapItem { index: JeanDamageEnum::Q2 as usize, chs: "Field Entering/Exiting Damage" },
            CharacterSkillMapItem { index: JeanDamageEnum::QHeal1 as usize, chs: "Field Activation Healing" },
            CharacterSkillMapItem { index: JeanDamageEnum::QHeal2 as usize, chs: "Continuous Regeneration" },
        ])
    };
