...
pub const YOIMIYA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Firework Flare-Up",
    skill_name2: "Elemental Skill: Niwabi Fire-Dance",
    skill_name3: "Elemental Burst: Ryuukin Saxifrage"
};
...
impl<T: Attribute> ChangeAttribute<T> for YoimiyaEffect {
    fn change_attribute(&self, attribute: &mut T) {
        if self.has_talent1 {
            attribute.set_value_by(AttributeName::BonusPyro, "Yoimiya's 1st Ascension Talent: Tricks of the Trouble-Maker", self.talent1_level * 0.02);
        }
    }
}
...
impl CharacterTrait for Yoimiya {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage/2" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage/2" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Charged1 as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Charged2 as usize, chs: "2- Charged Attack Damage" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Charged3 as usize, chs: "3- Charged Attack Damage" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: None,
        skill3: Some(&[
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: YoimiyaDamageEnum::Q2 as usize, chs: "Aurous Blaze Explosion Damage" },
        ])
    };
    ...
    const CONFIG_DATA: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "talent1_level",
            title: "Yoimiya's 1st Ascension Talent Stacks",
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "after_e",
            title: "Elemental Skill: Niwabi Fire-Dance",
