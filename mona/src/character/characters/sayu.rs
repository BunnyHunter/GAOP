...
pub const SAYU_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Shuumatsuban Ninja Blade",
    skill_name2: "Elemental Skill: Yoohoo Art: Fuuin Dash",
    skill_name3: "Elemental Burst: Yoohoo Art: Mujina Flurry"
};
...
impl CharacterTrait for Sayu {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: SayuDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::Normal31 as usize, chs: "3- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: SayuDamageEnum::Normal32 as usize, chs: "3- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: SayuDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::Charged1 as usize, chs: "Charge Attack Spinning Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::Charged2 as usize, chs: "Charge Attack Final Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: SayuDamageEnum::E1 as usize, chs: "Fuufuu Windwheel Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::E2 as usize, chs: "Fuufuu Whirlwind Kick Tap Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::E3 as usize, chs: "Fuufuu Whirlwind Kick Hold Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::E4Pyro as usize, chs: "Fuufuu Windwheel Pyro Element Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::E4Hydro as usize, chs: "Fuufuu Windwheel Hydro Element Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::E4Cryo as usize, chs: "Fuufuu Windwheel Cryo Element Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::E4Electro as usize, chs: "Fuufuu Windwheel Electro Element Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::E5Pyro as usize, chs: "Fuufuu Whirlwind Kick Pyro Element Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::E5Hydro as usize, chs: "Fuufuu Whirlwind Kick Hydro Element Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::E5Cryo as usize, chs: "Fuufuu Whirlwind Kick Cryo Element Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::E5Electro as usize, chs: "Fuufuu Whirlwind Kick Electro Element Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: SayuDamageEnum::Q1 as usize, chs: "Skill Activation Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::QHeal1 as usize, chs: "Skill Activation Healing" },
            CharacterSkillMapItem { index: SayuDamageEnum::Q2 as usize, chs: "Muji-Muji Daruma Damage" },
            CharacterSkillMapItem { index: SayuDamageEnum::QHeal2 as usize, chs: "Muji-Muji Daruma Healing" },
        ])
    };
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, _config: &CharacterSkillConfig) -> D::Result {
        ...
        if s.is_heal() {
            ...
            builder.add_extra_damage("Skill Multiplier", fixed);
            if s == QHeal2 && context.character_common_data.constellation >= 6 {
                ...
                builder.add_extra_damage("Sayu's 6th Constellation: Sleep O'Clock", extra);
            }
            ...
            if s == Q2 && context.character_common_data.constellation >= 6 {
                ...
                builder.add_atk_ratio("Sayu's 6th Constellation: Sleep O'Clock", bonus);
            }
            builder.damage(
                &context.attribute,
                &context.enemy,
