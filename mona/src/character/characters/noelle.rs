...
pub const NOELLE_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Favonius Bladework - Maid",
    skill_name2: "Elemental Skill: Breastplate",
    skill_name3: "Elemental Burst: Sweeping Time"
};
...
impl CharacterTrait for Noelle {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: NoelleDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: NoelleDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: NoelleDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: NoelleDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: NoelleDamageEnum::Charged1 as usize, chs: "Charge Attack Spinning Damage" },
            CharacterSkillMapItem { index: NoelleDamageEnum::Charged2 as usize, chs: "Charge Attack Final Damage" },
            CharacterSkillMapItem { index: NoelleDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: NoelleDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: NoelleDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: NoelleDamageEnum::E1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: NoelleDamageEnum::EHeal1 as usize, chs: "Healing" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: NoelleDamageEnum::Q1 as usize, chs: "Burst Damage" },
            CharacterSkillMapItem { index: NoelleDamageEnum::Q2 as usize, chs: "Skill Damage" },
        ])
    };
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "after_q",
            title: "Elemental Burst: Sweeping Time",
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if s.is_heal() {
            ...
            if after_q {
                ...
                builder.add_extra_atk("ATK Bonus", atk_bonus);
            }
