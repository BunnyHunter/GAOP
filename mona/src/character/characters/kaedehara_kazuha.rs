...
pub const KAEDEHARA_KAZUHA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Garyuu Bladework",
    skill_name2: "Elemental Skill: Chihayaburu",
    skill_name3: "Elemental Burst: Kazuha Slash"
};
...
impl CharacterTrait for KaedeharaKazuha {
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "after_e_or_q",
            title: "Kaedehara Kazuha's 6th Constellation: Crimson Momiji",
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Normal31 as usize, chs: "3- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Normal32 as usize, chs: "3- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage/3" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Charged11 as usize, chs: "1- Charged Attack Damage-1" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Charged11 as usize, chs: "1- Charged Attack Damage-2" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::PlungingE1 as usize, chs: "Midare Ranzan: Plunging Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::PlungingE2 as usize, chs: "Midare Ranzan: Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::PlungingE3 as usize, chs: "Midare Ranzan: High Plunge Damage Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::PlungingPyro as usize, chs: "Midare Ranzan: Pyro Infusion Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::PlungingHydro as usize, chs: "Midare Ranzan: Hydro Infusion Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::PlungingCryo as usize, chs: "Midare Ranzan: Cryo Infusion Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::PlungingElectro as usize, chs: "Midare Ranzan: Electro Infusion Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::E1 as usize, chs: "Tap Skill Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::E2 as usize, chs: "Hold Skill Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Q1 as usize, chs: "Slashing Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Q2 as usize, chs: "Damage Over Time" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Q3Pyro as usize, chs: "Additional Pyro Element Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Q3Hydro as usize, chs: "Additional Hydro Element Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Q3Cryo as usize, chs: "Additional Cryo Element Damage" },
            CharacterSkillMapItem { index: KaedeharaKazuhaDamageEnum::Q3Electro as usize, chs: "Additional Electro Element Damage" },
        ])
    };
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        builder.add_atk_ratio("Skill Multiplier", ratio);
        ...
        if after_e_or_q && (skill_type == SkillType::NormalAttack || skill_type == SkillType::ChargedAttack || skill_type == SkillType::PlungingAttack) {
            ...
            let bonus = em * 0.002;
            builder.add_extra_bonus("Kaedehara Kazuha's 6th Constellation: Crimson Momiji", bonus);
        }
