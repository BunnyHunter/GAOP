...
pub const ROSARIA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Spear of the Church",
    skill_name2: "Elemental Skill: Ravaging Confession",
    skill_name3: "Elemental Burst: Rites of Termination"
};
...
impl CharacterTrait for Rosaria {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: RosariaDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage/2" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Normal51 as usize, chs: "5- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Normal52 as usize, chs: "5- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: RosariaDamageEnum::E11 as usize, chs: "Skill Damage-1" },
            CharacterSkillMapItem { index: RosariaDamageEnum::E12 as usize, chs: "Skill Damage-2" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: RosariaDamageEnum::Q11 as usize, chs: "Skill Damage-1" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Q12 as usize, chs: "Skill Damage-2" },
            CharacterSkillMapItem { index: RosariaDamageEnum::Q2 as usize, chs: "Ice Lance Damage Over Time" },
        ])
    };
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "e_from_behind",
            title: "Rosaria's 1st Ascension Talent: Regina Probationum",
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if s == E12 && e_from_behind && context.character_common_data.has_talent1 {
            builder.add_extra_critical("Rosaria's 1st Ascension Talent: Regina Probationum", 0.12);
        }
