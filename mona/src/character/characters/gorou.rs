...
pub const GOROU_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Ripping Fang Fletching",
    skill_name2: "Elemental Skill: Inuzaka All-Round Defense",
    skill_name3: "Elemental Burst: Juuga: Forward Unto Victory"
};
...
impl CharacterTrait for Gorou {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: GorouDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: GorouDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: GorouDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: GorouDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: GorouDamageEnum::Charged1 as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: GorouDamageEnum::Charged2 as usize, chs: "2- Charged Attack Damage" },
            CharacterSkillMapItem { index: GorouDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: GorouDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: GorouDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: GorouDamageEnum::E1 as usize, chs: "Skill Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: GorouDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: GorouDamageEnum::Q2 as usize, chs: "Crystal Collapse Damage" },
        ])
    };
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, _config: &CharacterSkillConfig) -> D::Result {
        ...
        if context.character_common_data.has_talent2 {
            if skill_type == SkillType::ElementalSkill {
                builder.add_def_ratio("Gorou's 2nd Ascension Talent: A Favor Repaid", 1.56);
            } else if skill_type == SkillType::ElementalBurst {
                builder.add_def_ratio("Gorou's 2nd Ascension Talent: A Favor Repaid", 0.156);
            }
        }
