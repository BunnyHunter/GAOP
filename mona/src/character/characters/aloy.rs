...
pub const ALOY_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Rapid Fire",
    skill_name2: "Elemental Skill: Frozen Wilds",
    skill_name3: "Elemental Burst: Prophecies of Dawn"
};
...
impl CharacterTrait for Aloy {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: AloyDamageEnum::Normal11 as usize, chs: "1- Normal Attack Damage 1" },
            CharacterSkillMapItem { index: AloyDamageEnum::Normal12 as usize, chs: "1- Normal Attack Damage 2" },
            CharacterSkillMapItem { index: AloyDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: AloyDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: AloyDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: AloyDamageEnum::Charged1 as usize, chs: "Aim Shot" },
            CharacterSkillMapItem { index: AloyDamageEnum::Charged2 as usize, chs: "Aim Shot Full Charge" },
            CharacterSkillMapItem { index: AloyDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: AloyDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage" },
            CharacterSkillMapItem { index: AloyDamageEnum::Plunging3 as usize, chs: "High Plunge Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: AloyDamageEnum::E1 as usize, chs: "Freeze Bomb Damage" },
            CharacterSkillMapItem { index: AloyDamageEnum::E2 as usize, chs: "Chillwater Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: AloyDamageEnum::Q1 as usize, chs: "Skill Damage" }
        ])
    };
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if coil_count > 0 && skill_type == SkillType::NormalAttack {
            ...
            if coil_count < 4 {
                builder.add_extra_bonus("Coil Bonus", bonus);
            } else {
                builder.add_extra_bonus("Rushing Ice Bonus", bonus);
            }
        }
