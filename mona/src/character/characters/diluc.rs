...
const DILUC_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Tempered Sword",
    skill_name2: "Elemental Skill: Searing Onslaught",
    skill_name3: "Elemental Burst: Dawn"
};
...
impl CharacterTrait for Diluc {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: DilucDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: DilucDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: DilucDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: DilucDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: DilucDamageEnum::Charged1 as usize, chs: "Charge Attack Spinning DMG" },
            CharacterSkillMapItem { index: DilucDamageEnum::Charged2 as usize, chs: "Charge Attack Final DMG" },
            CharacterSkillMapItem { index: DilucDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: DilucDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: DilucDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: DilucDamageEnum::E1 as usize, chs: "1- Hit Damage" },
            CharacterSkillMapItem { index: DilucDamageEnum::E2 as usize, chs: "2- Hit Damage" },
            CharacterSkillMapItem { index: DilucDamageEnum::E3 as usize, chs: "3- Hit Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: DilucDamageEnum::Q1 as usize, chs: "Slashing Damage" },
            CharacterSkillMapItem { index: DilucDamageEnum::Q2 as usize, chs: "Damage Over Time" },
            CharacterSkillMapItem { index: DilucDamageEnum::Q3 as usize, chs: "Explosion Damage" },
        ])
    };
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "pyro",
            title: "Elemental Burst Pyro Infusion Active ?",
