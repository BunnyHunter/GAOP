...
pub const KAMISATO_AYAKA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Kamisato Art: Kabuki",
    skill_name2: "Elemental Skill: Kamisato Art: Hyouka",
    skill_name3: "Elemental Burst: Kamisato Art: Soumetsu"
};
...
impl<A: Attribute> ChangeAttribute<A> for KamisatoAyakaEffect {
    fn change_attribute(&self, attribute: &mut A) {
        if self.has_talent1 {
            attribute.set_value_by(AttributeName::BonusNormalAttack, "Kamisato Ayaka's 1st Ascension Talent: Amatsumi Kunitsumi Sanctification", 0.3 * self.rate1);
            attribute.set_value_by(AttributeName::BonusChargedAttack, "Kamisato Ayaka's 1st Ascension Talent: Amatsumi Kunitsumi Sanctification", 0.3 * self.rate1);
        }
        if self.has_talent2 {
            attribute.set_value_by(AttributeName::BonusCryo, "Kamisato Ayaka's 2nd Ascension Talent: Kanten Senmyou Blessing", 0.18 * self.rate2);
        }
    }
}
...
impl CharacterTrait for KamisatoAyaka {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage/3" },
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Charged as usize, chs: "1- Charged Attack Damage/3" },
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::E1 as usize, chs: "Skill Damage" }
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Q1 as usize, chs: "Cutting Damage" },
            CharacterSkillMapItem { index: KamisatoAyakaDamageEnum::Q2 as usize, chs: "Bloom Damage" },
        ])
    };
    ...
    const CONFIG_DATA: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "talent1_rate",
            title: "Kamisato Ayaka's 1st Ascension Talent Uptime",
            config: ItemConfig::RATE01_TYPE
        },
        ItemConfig {
            name: "talent2_rate",
            title: "Kamisato Ayaka's 2nd Ascension Talent Uptime",
            config: ItemConfig::RATE01_TYPE
        }
    ]);
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "after_dash",
            title: "Alternate Sprint: Kamisato Art: Senho",
            config: ItemConfigType::Bool { default: true }
        },
        ItemConfig {
            name: "use_c6",
            title: "Kamisato Ayaka's 6th Constellation",
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if skill_type == SkillType::ChargedAttack && use_c6 {
            builder.add_extra_bonus("Kamisato Ayaka's 6th Constellation: Dance of Suigetsu", 2.98);
        }
