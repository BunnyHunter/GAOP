...
pub const KUJOU_SARA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Tengu Bowmanship",
    skill_name2: "Elemental Skill: Tengu Stormcall",
    skill_name3: "Elemental Burst: Subjugation: Koukou Sendou"
};
...
impl CharacterTrait for KujouSara {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Charged1 as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Charged2 as usize, chs: "2- Charged Attack Damage" },
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: KujouSaraDamageEnum::E1 as usize, chs: "Tengu Juurai: Ambush Damage" }
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Q1 as usize, chs: "Tengu Juurai: Titanbreaker Damage " },
            CharacterSkillMapItem { index: KujouSaraDamageEnum::Q2 as usize, chs: "Tengu Juurai: Stormcluster Damage " },
        ])
    };
