...
pub const GANYU_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Liutian Archery",
    skill_name2: "Elemental Skill: Trail of the Qilin",
    skill_name3: "Elemental Burst: Celestial Shower"
};
...
impl<T: Attribute> ChangeAttribute<T> for GanyuEffect {
    fn change_attribute(&self, attribute: &mut T) {
        attribute.set_value_by(AttributeName::CriticalBase, "Ganyu's 1st Ascension Talent: Undivided Heart", 0.2 * self.talent1_rate);
        attribute.set_value_by(AttributeName::BonusCryo, "Ganyu's 2nd Ascension Talent: Harmony between Heaven and Earth", 0.2 * self.talent2_rate);
    }
}
...
impl CharacterTrait for Ganyu {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: GanyuDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Normal6 as usize, chs: "6- Normal Attack Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Charged1 as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Charged2 as usize, chs: "Aimed Shot" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Charged3 as usize, chs: "Frostflake Arrow Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Charged4 as usize, chs: "Frostflake Arrow Bloom Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: GanyuDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: GanyuDamageEnum::E1 as usize, chs: "Skill Damage" }
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: GanyuDamageEnum::Q1 as usize, chs: "Ice Shard Damage" }
        ])
    };
    ...
    const CONFIG_DATA: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "talent1_rate",
            title: "Ganyu's 1st Ascension Talent: Undivided Heart Uptime",
            config: ItemConfig::RATE01_TYPE
        },
        ItemConfig {
            name: "talent2_rate",
            title: "Ganyu's 2nd Ascension Talent: Harmony between Heaven and Earth Uptime",
            config: ItemConfig::RATE01_TYPE
        }
    ]);
