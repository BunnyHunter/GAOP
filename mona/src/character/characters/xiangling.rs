...
pub const XIANGLING_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Dough-Fu",
    skill_name2: "Elemental Skill: Guoba Attack",
    skill_name3: "Elemental Burst: Pyronado"
};
...
impl CharacterTrait for Xiangling {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: XianglingDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Normal31 as usize, chs: "3- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Normal32 as usize, chs: "3- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage/4" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: XianglingDamageEnum::E1 as usize, chs: "Flame Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: XianglingDamageEnum::Q1 as usize, chs: "1-Hit Swing Damage" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Q2 as usize, chs: "2-Hit Swing Damage" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Q3 as usize, chs: "3-Hit Swing Damage" },
            CharacterSkillMapItem { index: XianglingDamageEnum::Q4 as usize, chs: "Pyronado Damage " },
        ])
    };
