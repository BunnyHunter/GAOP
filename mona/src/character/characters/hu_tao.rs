...
pub const HU_TAO_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Secret Spear of Wangsheng",
    skill_name2: "Elemental Skill: Guide to Afterlife",
    skill_name3: "Elemental Burst: Spirit Soother"
};
...
impl<T: Attribute> ChangeAttribute<T> for HuTaoEffect {
    fn change_attribute(&self, attribute: &mut T) {
        if self.has_talent2 && self.le_50 {
            attribute.set_value_by(AttributeName::BonusPyro, "Hu Tao's 2nd Ascension Talent: Sanguine Rouge", 0.33);
        }
    }
}
...
impl CharacterTrait for HuTao {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: HuTaoDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::Normal51 as usize, chs: "5- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::Normal52 as usize, chs: "5- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::Normal6 as usize, chs: "6- Normal Attack Damage" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::Charged as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: HuTaoDamageEnum::ElementalSkillBloodBlossom as usize, chs: "Blood Blossom Damage" }
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: HuTaoDamageEnum::ElementalBurst1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: HuTaoDamageEnum::ElementalBurstLow1 as usize, chs: "Low HP Skill Damage" },
        ])
    };
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "after_e",
            title: "Elemental Skill: Guide to Afterlife Active",
            config: ItemConfigType::Bool { default: true }
        }
    ]);
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if after_e {
            ...
            builder.add_extra_atk("Guide to Afterlife ATK Bonus", atk_bonus);
        }
