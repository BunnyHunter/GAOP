...
pub const AMBER_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack · Marksman",
    skill_name2: "Explosive Puppet",
    skill_name3: "Fiery Rain"
};
...
impl<T: Attribute> ChangeAttribute<T> for AmberEffect {
    fn change_attribute(&self, attribute: &mut T) {
        if self.has_talent1 {
            attribute.set_value_by(AttributeName::CriticalElementalBurst, "Amber Talent 1", 0.1);
        }
    }
}
...
impl CharacterTrait for Amber {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: AmberDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage " },
            CharacterSkillMapItem { index: AmberDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage " },
            CharacterSkillMapItem { index: AmberDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage " },
            CharacterSkillMapItem { index: AmberDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage " },
            CharacterSkillMapItem { index: AmberDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage " },
            CharacterSkillMapItem { index: AmberDamageEnum::Charged1 as usize, chs: "Aim Shot" },
            CharacterSkillMapItem { index: AmberDamageEnum::Charged2 as usize, chs: "Aim Shot Full Charge" },
            CharacterSkillMapItem { index: AmberDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: AmberDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage" },
            CharacterSkillMapItem { index: AmberDamageEnum::Plunging3 as usize, chs: "High Plunge Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: AmberDamageEnum::E1 as usize, chs: "Explosion Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: AmberDamageEnum::Q1 as usize, chs: "Fiery Rain Damage Per Wave" },
            CharacterSkillMapItem { index: AmberDamageEnum::Q2 as usize, chs: "Total Fiery Rain Damage" },
        ])
    };
