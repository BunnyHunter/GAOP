...
pub const RAZOR_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Steel Fang",
    skill_name2: "Elemental Skill: Claw and Thunder",
    skill_name3: "Elemental Burst: Lightning Fang"
};
...
impl<A: Attribute> ChangeAttribute<A> for RazorEffect {
    fn change_attribute(&self, attribute: &mut A) {
        ...
        attribute.set_value_by(AttributeName::Recharge, "Razor's 2nd Ascesion Talent: Hunger", recharge_bonus);
        if self.has_talent2 {
            attribute.set_value_by(AttributeName::Recharge, "Razor's 2nd Ascesion Talent: Hunger", self.talent2_ratio * 0.3);
        }
    }
}
...
impl CharacterTrait for Razor {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: RazorDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::Charged1 as usize, chs: "Charge Attack Spinning Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::Charged2 as usize, chs: "Charge Attack Final Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: RazorDamageEnum::E1 as usize, chs: "Tap Skill Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::E2 as usize, chs: "Hold Skill Damage " },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: RazorDamageEnum::Q1 as usize, chs: "Elemental Burst Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::QNormal1 as usize, chs: "Soul Companion -1- Normal Attack Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::QNormal2 as usize, chs: "Soul Companion -2- Normal Attack Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::QNormal3 as usize, chs: "Soul Companion -3- Normal Attack Damage" },
            CharacterSkillMapItem { index: RazorDamageEnum::QNormal4 as usize, chs: "Soul Companion -4- Normal Attack Damage" },
        ])
    };
    ...
    const CONFIG_DATA: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "e_stack",
            title: "Elemental Skill: Claw and Thunder Stacks",
            config: ItemConfigType::Float { min: 0.0, max: 3.0, default: 0.0 }
        },
        ItemConfig {
            name: "talent2_ratio",
            title: "Razor's 2nd Ascesion Talent Ratio",
