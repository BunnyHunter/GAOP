...
pub const VENTI_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Divine Marksmanship",
    skill_name2: "Elemental Skill: Skyward Sonnet",
    skill_name3: "Elemental Burst: Wind's Grand Ode"
};
...
impl CharacterTrait for Venti {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: VentiDamageEnum::Normal11 as usize, chs: "1- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: VentiDamageEnum::Normal12 as usize, chs: "1- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: VentiDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Normal41 as usize, chs: "4- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: VentiDamageEnum::Normal42 as usize, chs: "4- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: VentiDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Normal6 as usize, chs: "6- Normal Attack Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Charged1 as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Charged2 as usize, chs: "2- Charged Attack Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: VentiDamageEnum::E1 as usize, chs: "Tap Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::E2 as usize, chs: "Hold Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: VentiDamageEnum::Q1 as usize, chs: "Damage Over Time" },
            CharacterSkillMapItem { index: VentiDamageEnum::Q2Pyro as usize, chs: "Additional Pyro Element Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Q2Hydro as usize, chs: "Additional Hydro Element Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Q2Cryo as usize, chs: "Additional Cryo Element Damage" },
            CharacterSkillMapItem { index: VentiDamageEnum::Q2Electro as usize, chs: "Additional Electro Element Damage" },
        ])
    };
