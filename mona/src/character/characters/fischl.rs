...
pub const FISCHL_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Bolts of Downfall",
    skill_name2: "Elemental Skill: Nightrider",
    skill_name3: "Elemental Burst: Midnight Phantasmagoria"
};
...
impl CharacterTrait for Fischl {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: FischlDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: FischlDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: FischlDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: FischlDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: FischlDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: FischlDamageEnum::Charged1 as usize, chs: "1- Charged Attack Damage" },
            CharacterSkillMapItem { index: FischlDamageEnum::Charged2 as usize, chs: "2- Charged Attack Damage" },
            CharacterSkillMapItem { index: FischlDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: FischlDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: FischlDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: FischlDamageEnum::E1 as usize, chs: "Oz Attack Damage" },
            CharacterSkillMapItem { index: FischlDamageEnum::E2 as usize, chs: "Summoning Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: FischlDamageEnum::Q1 as usize, chs: "Falling Thunder Damage" }
        ])
    };
