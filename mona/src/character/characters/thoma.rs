...
pub const THOMA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Swiftshatter Spear",
    skill_name2: "Elemental Skill: Blazing Blessing",
    skill_name3: "Elemental Burst: Crimson Ooyoroi"
};
...
impl CharacterTrait for Thoma {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: ThomaDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: ThomaDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: ThomaDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage/2" },
            CharacterSkillMapItem { index: ThomaDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: ThomaDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: ThomaDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: ThomaDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: ThomaDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: ThomaDamageEnum::E1 as usize, chs: "Skill Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: ThomaDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: ThomaDamageEnum::Q2 as usize, chs: "Fiery Collapse Damage" },
        ])
    };
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, _config: &CharacterSkillConfig) -> D::Result {
        ...
        if s == Q2 && context.character_common_data.has_talent2 {
            builder.add_hp_ratio("Thoma's 2nd Ascension Talent: Flaming Assault", 0.022);
        }
        builder.damage(
            &context.attribute,
            &context.enemy,
