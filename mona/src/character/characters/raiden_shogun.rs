...
pub const RAIDEN_SHOGUN_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Origin",
    skill_name2: "Elemental Skill: Transcendence: Baleful Omen",
    skill_name3: "Elemental Burst: Secret Art: Musou Shinsetsu"
};
    ...
    fn change_attribute(&self, attribute: &mut T) {
        if self.has_talent2 {
            attribute.add_edge1(
                ...
                "Raiden Shogun;s 2nd Ascesion Talent: Enlightened One"
            );
        }
    }
}
...
impl CharacterTrait for RaidenShogun {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Normal41 as usize, chs: "4- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Normal42 as usize, chs: "4- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::E1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::E2 as usize, chs: "Coordinated Attack Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::Q1 as usize, chs: "Musou no Hitotachi Base Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QNormal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QNormal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QNormal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QNormal41 as usize, chs: "4- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QNormal42 as usize, chs: "4- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QNormal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QCharged11 as usize, chs: "1- Charged Attack Damage-1" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QCharged12 as usize, chs: "1- Charged Attack Damag-2" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QPlunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QPlunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: RaidenShogunDamageEnum::QPlunging3 as usize, chs: "High Plunge Damage Damage" },
        ])
    };
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "under_e",
            title: "Eye of Stormy Judgment",
            config: ItemConfigType::Bool { default: true }
        },
        ItemConfig {
            name: "resolve_stack",
            title: "Resolve Stacks",
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if skill_type == SkillType::ElementalBurst {
            if under_e {
                ...
                builder.add_extra_bonus("Eye of Stormy Judgment", bonus_per_energy * 90.0);
            }
            ...
            builder.add_atk_ratio("ATK Bonus", extra_ratio);

            let is_conste2 = context.character_common_data.constellation >= 2;
            if is_conste2 {
                builder.add_extra_def_penetration("Raiden Shongun's 2nd Constellation: Steelbreaker", 0.6);
            }
        }
