...
pub const LISA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Lightning Touch",
    skill_name2: "Elemental Skill: Violet Arc",
    skill_name3: "Elemental Burst: Lightning Rose"
};
...
impl CharacterTrait for Lisa {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: LisaDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: LisaDamageEnum::E1 as usize, chs: "Tap Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::E2 as usize, chs: "Non-Conductive Hold Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::E3 as usize, chs: "Stack 1 Conductive Hold Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::E4 as usize, chs: "Stack 2 Conductive Hold Damage" },
            CharacterSkillMapItem { index: LisaDamageEnum::E5 as usize, chs: "Stack 3 Conductive Hold Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: LisaDamageEnum::Q1 as usize, chs: "Discharge Damage" }
        ])
    };
