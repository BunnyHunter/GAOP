...
const BEIDOU_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Oceanborne",
    skill_name2: "Elemental Skill: Tidecaller",
    skill_name3: "Elemental Burst: Stormbreaker"
};
...
impl CharacterTrait for Beidou {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: BeidouDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::Charged1 as usize, chs: "Charge Attack Spinning Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::Charged2 as usize, chs: "Charge Attack Final Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: BeidouDamageEnum::E1 as usize, chs: "Base Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::E2 as usize, chs: "Charge Level 1 Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::E3 as usize, chs: "Charge Level 2 Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: BeidouDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: BeidouDamageEnum::Q2 as usize, chs: "Lightning Damage" },
        ])
    };
