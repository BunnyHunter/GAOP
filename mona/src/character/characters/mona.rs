...
pub const MONA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Ripple of Fate",
    skill_name2: "Elemental Skill: Mirror Reflection of Doom",
    skill_name3: "Elemental Burst: Stellaris Phantasm"
};
    ...
    fn change_attribute(&self, attribute: &mut T) {
        if self.has_talent2 {
            attribute.add_edge1(
                ...
                "Mona's 2nd Ascension Talent: Waterborne Destiny"
            );
        }
    }
}
...
impl CharacterTrait for Mona {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: MonaDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: MonaDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: MonaDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: MonaDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: MonaDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: MonaDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: MonaDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: MonaDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: MonaDamageEnum::E1 as usize, chs: "Damage Over Time" },
            CharacterSkillMapItem { index: MonaDamageEnum::E2 as usize, chs: "Explosion Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: MonaDamageEnum::Q1 as usize, chs: "Illusory Bubble Explosion Damage" }
        ])
    };
