...
pub const XINYAN_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Dance on Fire",
    skill_name2: "Elemental Skill: Sweeping Fervor",
    skill_name3: "Elemental Burst: Riff Revolution"
};
...
impl CharacterTrait for Xinyan {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: XinyanDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: XinyanDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: XinyanDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: XinyanDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: XinyanDamageEnum::Charged1 as usize, chs: "Charge Attack Spinning DMG" },
            CharacterSkillMapItem { index: XinyanDamageEnum::Charged2 as usize, chs: "Charge Attack Final DMG" },
            CharacterSkillMapItem { index: XinyanDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: XinyanDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: XinyanDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: XinyanDamageEnum::E1 as usize, chs: "Swing Damage" },
            CharacterSkillMapItem { index: XinyanDamageEnum::E2 as usize, chs: "Damage Over Time" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: XinyanDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: XinyanDamageEnum::Q2 as usize, chs: "Pyro Element Damage Over Time" },
        ])
    };
