...
pub const BENNETT_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 4,
    skill_name1: "Normal Attack: Strike of Fortune",
    skill_name2: "Elemental Skill: Passion Overload",
    skill_name3: "Elemental Burst: Fantastic Voyage"
};
...
impl CharacterTrait for Bennett {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: BennettDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: BennettDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: BennettDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: BennettDamageEnum::Normal4 as usize, chs: "4- Normal Attack Damage" },
            CharacterSkillMapItem { index: BennettDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: BennettDamageEnum::Charged11 as usize, chs: "1- Charged Attack Damage-1" },
            CharacterSkillMapItem { index: BennettDamageEnum::Charged12 as usize, chs: "1- Charged Attack Damage-2" },
            CharacterSkillMapItem { index: BennettDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: BennettDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: BennettDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: BennettDamageEnum::E1 as usize, chs: "Tap Damage" },
            CharacterSkillMapItem { index: BennettDamageEnum::E21 as usize, chs: "Charge Level 1 Damage-1" },
            CharacterSkillMapItem { index: BennettDamageEnum::E22 as usize, chs: "Charge Level 1 Damage-2" },
            CharacterSkillMapItem { index: BennettDamageEnum::E31 as usize, chs: "Charge Level 2 Damage-1" },
            CharacterSkillMapItem { index: BennettDamageEnum::E32 as usize, chs: "Charge Level 2 Damage-2" },
            CharacterSkillMapItem { index: BennettDamageEnum::E4 as usize, chs: "Explosion Damage" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: BennettDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: BennettDamageEnum::QHeal as usize, chs: "Continuous Regeneration" },
        ])
    };
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, _config: &CharacterSkillConfig) -> D::Result {
        ...
        if s.is_heal() {
            ...
            builder.add_hp_ratio("Skill Multiplier", ratio);
