...
pub const XIAO_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Whirlwind Thrust",
    skill_name2: "Elemental Skill: Lemniscatic Wind Cycling",
    skill_name3: "Elemental Burst: Bane of All Evil"
};
...
impl CharacterTrait for Xiao {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: XiaoDamageEnum::Normal11 as usize, chs: "1- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Normal12 as usize, chs: "1- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Normal41 as usize, chs: "4- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Normal42 as usize, chs: "4- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Normal6 as usize, chs: "6- Normal Attack Damage" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Charged as usize, chs: "Charged Attack Damage" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: XiaoDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: XiaoDamageEnum::E1 as usize, chs: "Skill Damage" }
        ]),
        skill3: None
    };
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ...
        ItemConfig {
            name: "talent1_stack",
            title: "Xiao's 1st Ascension Talent: Conqueror of Evil: Tamer of Demons Stacks",
            config: ItemConfigType::Float { min: 0.0, max: 4.0, default: 4.0 },
        },
        ItemConfig {
            name: "talent2_stack",
            title: "Xiao's 2nd Ascension Talent: Dissolution Eon: Heaven Fall Stacks",
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig) -> D::Result {
        ...
        if after_q && s.is_affected_by_q() {
            ...
            builder.add_extra_bonus("Elemental Burst: Bane of All Evil Damage Bonus", bonus);

            if context.character_common_data.has_talent1 {
                builder.add_extra_bonus("Xiao's 1st Ascension Talent Bonus", 0.05 + talent1_stack * 0.05);
            }
        }

        if s == E1 && context.character_common_data.has_talent2 {
            builder.add_extra_bonus("Xiao's 2nd Ascension Talent Stacks", 0.15 * talent2_stack);
        }
