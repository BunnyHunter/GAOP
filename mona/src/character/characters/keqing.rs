...
pub const KEQING_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    star: 5,
    skill_name1: "Normal Attack: Yunlai Swordsmanship",
    skill_name2: "Elemental Skill: Stellar Restoration",
    skill_name3: "Elemental Burst: Starward Sword"
};
...
impl<A: Attribute> ChangeAttribute<A> for KeqingEffect {
    fn change_attribute(&self, attribute: &mut A) {
        if self.has_talent2 {
            attribute.set_value_by(AttributeName::CriticalBase, "Keqing's 2nd Ascesion Talent: Aristocratic Dignity", 0.15 * self.rate);
            attribute.set_value_by(AttributeName::Recharge, "Keqing's 2nd Ascesion Talent: Aristocratic Dignity", 0.15 * self.rate);
        }
    }
}
...
impl CharacterTrait for Keqing {
    ...
    const SKILL_MAP: CharacterSkillMap = CharacterSkillMap {
        skill1: Some(&[
            CharacterSkillMapItem { index: KeqingDamageEnum::Normal1 as usize, chs: "1- Normal Attack Damage" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Normal2 as usize, chs: "2- Normal Attack Damage" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Normal3 as usize, chs: "3- Normal Attack Damage" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Normal41 as usize, chs: "4- Normal Attack Damage-1" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Normal42 as usize, chs: "4- Normal Attack Damage-2" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Normal5 as usize, chs: "5- Normal Attack Damage" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Charged11 as usize, chs: "1- Charged Attack Damage-1" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Charged12 as usize, chs: "1- Charged Attack Damage-2" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Plunging1 as usize, chs: "Plunging Damage" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Plunging2 as usize, chs: "Low Plunge Damage Damage" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Plunging3 as usize, chs: "High Plunge Damage Damage" },
        ]),
        skill2: Some(&[
            CharacterSkillMapItem { index: KeqingDamageEnum::E1 as usize, chs: "Lightning Stiletto Damage" },
            CharacterSkillMapItem { index: KeqingDamageEnum::E2 as usize, chs: "Slashing Damage " },
            CharacterSkillMapItem { index: KeqingDamageEnum::E3 as usize, chs: "Thunderclap Slash Damagex2" },
        ]),
        skill3: Some(&[
            CharacterSkillMapItem { index: KeqingDamageEnum::Q1 as usize, chs: "Skill Damage" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Q2 as usize, chs: "Consecutive Slash Damagex8" },
            CharacterSkillMapItem { index: KeqingDamageEnum::Q3 as usize, chs: "Last Attack Damage" },
        ])
    };
    ...
    const CONFIG_DATA: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "talent2_rate",
            title: "Keqing's 2nd Ascesion Talent Ratio",
    ...
    const CONFIG_SKILL: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "after_e",
            title: "Elemental Skill: Stellar Restoration",
