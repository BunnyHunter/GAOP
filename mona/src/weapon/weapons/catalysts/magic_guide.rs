...
impl<A: Attribute> WeaponEffect<A> for MagicGuideEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut A) {
        ...
        attribute.set_value_by(AttributeName::BonusBase, "Magic Guide Passive Equivalent", value);
    }
}
...
impl WeaponTrait for MagicGuide {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("Bane of Storm and Tide: Increases DMG against opponents affected by Hydro or Electro by 12/15/18/21/24%."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Magic Guide"
    };
