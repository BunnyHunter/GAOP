...
impl<T: Attribute> WeaponEffect<T> for WindAndSongEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut T) {
        ...
        attribute.add_atk_percentage("Wine and Song Passive Equivalent", value);
    }
}
...
impl WeaponTrait for WindAndSong {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("Ever-Changing: Hitting and opponent with a Normal Attack decreases stamina consumption of Sprint or Alternate Sprint by 14/16/18/20/22% for 5s. Additionally, using a Spring or Alternate Sprint ability increases ATK by 20/25/30/35/40% for 5s."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Wine and Song"
    };
