...
impl<A: Attribute> WeaponEffect<A> for TwinNephriteEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut A) {
        ...
        attribute.add_atk_percentage("Twin Nephrite Passive Equivalent", value);
    }
}
...
impl WeaponTrait for TwinNephrite {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("Raiding Tactic: Defeating an opponent increases Movement SPD and ATK by 12/14/16/18/20% for 15s."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Twin Nephrite"
    };
