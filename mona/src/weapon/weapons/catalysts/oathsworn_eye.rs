...
impl<A: Attribute> WeaponEffect<A> for OathswornEyeEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut A) {
        ...
        attribute.set_value_by(AttributeName::Recharge, "Oathsworn Eye Passive Equivalent", recharge_bonus);
    }
}
...
impl WeaponTrait for OathswornEye {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("People of the Faltering Light: Increase Energy recharge by 24/30/36/42/48% for 10s after using an Elemental Skill."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Oathsworn Eye"
    };
