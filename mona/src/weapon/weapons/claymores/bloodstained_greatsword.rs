...
impl<A: Attribute> WeaponEffect<A> for BloodstainedGreatswordEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut A) {
        ...
        attribute.set_value_by(AttributeName::BonusBase, "Bloodtainted Greatsword Passive Equivalent", value);
    }
}
...
impl WeaponTrait for BloodstainedGreatsword {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("Bane of Fire and Thunder: Increases DMG against opponents affected by Pyro or Electro by 12/15/18/21/24%."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Bloodtainted Greatsword"
    };
