...
impl<T: Attribute> WeaponEffect<T> for SerpentSpineEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut T) {
        ...
        attribute.set_value_by(AttributeName::BonusBase, "Serpent Spine Sword Passive Equivalent", value);
    }
}
...
impl WeaponTrait for SerpentSpine {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("Wavesplitter: Every 4s a character is on the field, they will deal 6/7/8/9/10% more DMG and take 3/2.7/2.4/2.1/1.8% more DMG. This effect has a maximum of 5 stacks and will not be reset if the character leaves the field, but will be reduced by 1 stack when the character takes DMG."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Serpent Spine"
    };
    ...
    const CONFIG_DATA: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "stack",
            title: "Serpent Spine Passive Equivalent Stacks",
