...
impl<A: Attribute> WeaponEffect<A> for SkyriderSwordEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut A) {
        ...
        attribute.add_atk_percentage("Skyrider Sword Passive Equivalent", value);
    }
}
...
impl WeaponTrait for SkyriderSword {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("Determination: Using an Elemental Burst grants a 12/15/18/21/24% increase in ATK and Movement SPD for 15s."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Skyrider Sword"
    };
