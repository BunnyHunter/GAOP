...
impl<T: Attribute> WeaponEffect<T> for LionsRoarEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut T) {
        ...
        attribute.set_value_by(AttributeName::BonusBase, "Lions Roar Passive Equivalent", value);
    }
}
...
impl WeaponTrait for LionsRoar {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("Bane of Fire and Thunder: Increases DMG against enemies affected by Pyro or Electro by 20/24/28/32/36%."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Lions Roar"
    };
    ...
    const CONFIG_DATA: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "rate",
            title: "Lions Roar Passive Application Rate",
