...
impl<A: Attribute> WeaponEffect<A> for CoolSteelEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut A) {
        ...
        attribute.set_value_by(AttributeName::BonusBase, "Cool Steel Passive Equivalent", value);
    }
}
...
impl WeaponTrait for CoolSteel {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("Bane of Water and Ice: Increases DMG against opponents affected by Hydro or Cryo by 12/15/18/21/24%."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Cool Steel"
    };
