...
impl<T: Attribute> WeaponEffect<T> for CinnabarSpindleEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut T) {
        ...
        attribute.set_value_by(AttributeName::DEFRatioElementalSkill, "Cinnabar Spindle Passive Equivalent", value);
    }
}
...
impl WeaponTrait for CinnabarSpindle {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("Spotless Heart: Elemental Skill DMG is increased by 40/50/60/70/80% of DEF. The effect will be triggered no more than once every 1.5s and will be cleared 0.1s after the Elemental Skill deals DMG."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Cinnabar Spindle"
    };
    ...
    const CONFIG_DATA: Option<&'static [ItemConfig]> = Some(&[
        ItemConfig {
            name: "rate",
            title: "Cinnabar Spindle Passive Application Rate",
