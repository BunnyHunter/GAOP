...
impl<A: Attribute> WeaponEffect<A> for SharpshootersOathEffect {
    fn apply(&self, data: &WeaponCommonData, attribute: &mut A) {
        ...
        attribute.set_value_by(AttributeName::BonusBase, "Sharpshooters Oath Passive Equivalent", value);
    }
}
...
impl WeaponTrait for SharpshootersOath {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some("Precise: Increases DMG against weak spots by 24/30/36/42/48%."),
        #[cfg(not(target_family = "wasm"))]
        chs: "Sharpshooters Oath"
    };
