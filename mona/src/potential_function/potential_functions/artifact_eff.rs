...
impl PotentialFunctionMeta for PotentialFunctionArtifactEff {
    ...
    const CONFIG: Option<&'static [ItemConfig]> = Some(&[
        ...
        ItemConfig {
            name: "critical_use",
            title: "Effective Crit Rate",
            config: ItemConfigType::Bool { default: true }
        },
        ItemConfig {
            name: "critical_weight",
            title: "Crit Rate Weight",
            config: ItemConfigType::Float { min: 0.0, max: 1.0, default: 1.0 },
        },
        ItemConfig {
            name: "critical_damage_use",
            title: "Effective Crit Damage",
            config: ItemConfigType::Bool { default: true }
        },
        ItemConfig {
            name: "critical_damage_weight",
            title: "Crit Damage Weight",
            config: ItemConfigType::Float { min: 0.0, max: 1.0, default: 1.0 }
        },
        ItemConfig {
            name: "elemental_mastery_use",
            title: "Effective Elemental Mastery",
            config: ItemConfigType::Bool { default: false }
        },
        ItemConfig {
            name: "elemental_mastery_weight",
            title: "Elemental Mastery Weight",
            config: ItemConfig::RATE01_TYPE
        },
        ItemConfig {
            name: "recharge_use",
            title: "Effective Energy Recharge",
            config: ItemConfigType::Bool { default: false }
        },
        ItemConfig {
            name: "recharge_weight",
            title: "Energy Recharge Weight",
            config: ItemConfig::RATE01_TYPE
        }
    ]);
